  ...
  const plans = [
    {
      card_title: 'Free',
      price: '$0/mo',
      short_desc: 'Best for 1-5 users',
      available_features: ['One workspace', 'Email support'],
    ...
    },
    {
      card_title: 'Pro',
      price: '$49/mo',
      short_desc: 'Best for 5-50 users',
      available_features: [
        'One workspace',
        'Email support',
        'Basic analytics',
      ...
      not_available_features: ['Priority support', 'Unlimited file storage '],
    },
    {
      card_title: 'Enterprise',
      price: 'Contact us',
      short_desc: 'Best for 50+ users',
      available_features: [
        'One workspace',
        'Email support',
        'Basic analytics',
